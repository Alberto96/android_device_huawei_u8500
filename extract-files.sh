...
# Extract prebuilt libraries (from a CM7 running device) needed for the U8500
...
adb pull /system/etc/AudioFilterU8500.csv ../../../vendor/huawei/$DEVICE/proprietary/etc/AudioFilterU8500.csv
...
chmod 755 ../../../vendor/huawei/u8500/proprietary/bin/* 
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/huawei/__DEVICE__/proprietary/lib/librpc.so:system/lib/librpc.so 
...
PRODUCT_COPY_FILES += \\
    vendor/huawei/__DEVICE__/proprietary/lib/libauth.so:system/lib/libauth.so \\
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/huawei/__DEVICE__/proprietary/etc/AudioFilterU8500.csv:system/etc/AudioFilterU8500.csv 
