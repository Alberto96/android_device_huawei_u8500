...
TARGET_SPECIFIC_HEADER_PATH := device/huawei/u8500/include
...
# Recovery
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/huawei/u8500/recovery/recovery_ui.c
...
BOARD_EGL_CFG := device/huawei/u8500/prebuilt/lib/egl/egl.cfg
...
WIFI_DRIVER_MODULE_ARG := "firmware_path=/system/etc/firmware/fw_bcm4319.bin nvram_path=/system/etc/firmware/nvram.txt iface_name=eth"
WIFI_DRIVER_MODULE_NAME := "dhd"
WIFI_DRIVER_MODULE_PATH := "/system/lib/modules/bcm4319.ko"
WPA_SUPPLICANT_VERSION := VER_0_5_X

# Kernel
TARGET_PREBUILT_RECOVERY_KERNEL := device/huawei/u8500/prebuilt/recovery_kernel
BOARD_KERNEL_BASE := 0x00200000
BOARD_KERNEL_CMDLINE := mem=211M console=ttyMSM2,115200n8 androidboot.hardware=u8500
